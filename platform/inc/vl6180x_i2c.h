...
#define VL6180x_DoneI2CAccess(dev)   pthread_mutex_unlock(dev->lock)
 * @endcode
 */
...
/** @def VL6180x_DoneI2CAccess
 * @brief Default 'do-nothing' macro for @a VL6180x_DoneI2CAccess(). Delete if used.
 * @ingroup cci_i2c
 */
